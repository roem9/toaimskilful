                                ...
                                <div id="sesi-0">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <?= $form?>
                                            <div class="mb-3">
                                                <p>I hereby affirm that I am the person whose name is given on this answer sheet. (Dengan ini saya tegaskan bahwa saya adalah orang yang namanya tertera pada lembar jawaban ini.) . Jika dikemudian hari, diketahui bahwa terdapat kecurangan, maka kami akan menghapus nilai Test TOEFL kami dari data base, dan dianggap tidak berlaku.</p>
                                                <input type="checkbox" name="setuju" id="setuju" class="me-1 form-4"><label for="setuju">Ya</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
...
<script>
    ...
    $(".btnNext").click(function(){
        ...
        if(id == "sesi-1"){
            ...
            if($('#sesi-'+sesi+' input:radio:checked').length != jumlah_soal){
                if(sesi == 1){
                    msg = `Pekerjaan Anda Belum Selesai. Yakin akan pindah ke sesi selanjutnya?<br><small style="font-size: 0.70em" class="form-text text-danger">Anda tidak akan bisa kembali ke sesi ini</small>`
                } else {
                    msg = `Pekerjaan Anda Belum Selesai. Yakin akan pindah ke sesi selanjutnya?`
                }
            } else {
                if(sesi == 1){
    ...
    $(".btnSimpan").click(function(){
        ...
        if($('#sesi-'+sesi+' input:radio:checked').length != jumlah_soal){
            msg = `Pekerjaan Anda Belum Selesai. Yakin akan mengumpulkan tes Anda?`
        } else {
            msg = `Yakin telah menyelesaikan tes Anda?`
        }
